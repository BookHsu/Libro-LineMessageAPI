...
- [LINE Messaging API 2.0 規格速覽](https://github.com/BookHsu/Libro-LineMessageAPI/blob/master/docs/line-message-api-2.0.md)
- [參考範例專案](https://github.com/BookHsu/Libro-LineMessageAPI/tree/master/examples/Libro.LineMessageAPI.ExampleApi)
